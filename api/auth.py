...
# from core.auth import hash_password, verify_password, create_access_token, security
...
#     user = User(email=new_user.email, username=username, password_hash=hashed)
#     session.add(user)
#     session.commit()
...
#     try:
#         # decode done in create_access_token's counterpart (jwt.decode)
